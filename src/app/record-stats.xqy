...
(
	...
	(xs:QName("run-start-time"),$run-start-time,xs:QName("batch-start-time"),$batch-start-time,xs:QName("db-name"),$db-name,xs:QName("run-data"),$run-data,xs:QName("batch-map"),$batch-map))
	return 
